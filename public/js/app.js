        ...
        [
          ...
          _c("div", {
            staticClass:
              "text-left border-gray border-solid border-l-4 pl-2 text-sm mb-4 truncate max-w-xs",
            domProps: {
              textContent: _vm._s("Opend by: " + _vm.result.user.login)
            }
          }),
          _vm._v(" "),
          _c("div", { staticClass: "text-center text-xs mb-4" }, [
